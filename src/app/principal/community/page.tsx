...
export default function CommunityPage() {
  ...
  const handleQuestionDelete = async (id: string) => {
    try {
      const res = axios.delete(`/api/faq/delete-question?oid=${id}`);
      toast.promise(res, {
  ...
  const handleAnswerDelete = async (
    ...
    try {
      const res = axios.delete(
        `/api/faq/delete-answer?oid=${questionId}&answerIndex=${answerIndex}`
      );
      toast.promise(res, {
            ...
            {filteredFAQs.map((item) => (
              ...
              >
                ...
                <div className="collapse-title font-semibold text-lg flex justify-between items-center">
                  ...
                  <button
                    className="btn btn-xs btn-outline btn-error z-10"
                      ...
                      >
                        ...
                        <div className="flex justify-between items-center my-2">
                          ...
                          <button
                            ...
                            onClick={() => handleAnswerDelete(item._id!, idx)}
                          >
                            <IconTrash size={16} /> Delete Answer
                          </button>
                        </div>
