...
export default function StudentMessagePage() {
  ...
  const fetchConversations = async () => {
    setLoading(true);
    try {
      const res = await fetch("/api/conversations/student");
  ...
  const sendMessage = async () => {
    ...
    try {
      await axios.post(
        `/api/conversations/student/messages?conversationId=${selectedConversation._id}`,
        {
      ...
      setSelectedConversation({
        ...
        messages: [
          ...
          { content: messageInput, sender: { _id: user, model: "Student" } },
        ],
      });
